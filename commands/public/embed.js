module.exports = {
    ...
    execute(message, args) {
        ...
        //init embed
        if (!args[6]) return message.reply("Tapez ;embed help pour obtenir de l'aide")
