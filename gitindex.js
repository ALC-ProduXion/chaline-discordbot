...
repository = git.open('/ALC-ProduXion/chaline-discordbot');
...
const commandFiles = fs.readdirSync(repository + './commands').filter(file => file.endsWith('.js'));
const cmdgifFilesn = fs.readdirSync(repository + './gif/Normal').filter(file => file.endsWith('.js'));
const cmdgifFilesp = fs.readdirSync(repository + './gif/Plus').filter(file => file.endsWith('.js'));
const cmdgifFilesh = fs.readdirSync(repository + './gif/Hard').filter(file => file.endsWith('.js'));
